...
Credits:
    ...
    - Ponies images: https://www.freepngimg.com/cartoon/my-little-pony
...
$(document).ready(() => {
  ...
  for (let i in links) {
    ...
    if (i != links.length - 1) $('#marquee').append(' <img class="emoticon" src="assets/others/rdsmile.png"> ');
  }

  if (mobileAndTabletCheck()) {
    $('#background').replaceWith('<div id="background" style="background-position:center center; background-image: url(assets/images/mobile-background.jpg);"></div>');

    app.shouldIgnoreVideo = true;
  }

  app.titleChanger(['PlayDay', 'w1ldac3', '=', 'playday3008.github.io', 'Song name: KUSO GVKI - Cinnamon (feat. Apfel) (splash! Mag Premiere)']);
  app.iconChanger([
    "assets/icons/ponies/pony1.png",
    "assets/icons/ponies/pony2.png",
    "assets/icons/ponies/pony3.png",
    "assets/icons/ponies/pony4.png",
    "assets/icons/ponies/pony5.png",
    "assets/icons/ponies/pony6.png",
    "assets/icons/ponies/pony7.png",
    "assets/icons/ponies/pony8.png",
    "assets/icons/ponies/pony1.png",
]);
});
...
$.getJSON(ipgeolocation, (data) => {
  writeLine(['Authenticating...', "Granting access to <span style='font-size: 14px; color: #06d;'>[unknown]</span>..."], 30, () => {
    ...
    writeLine([`Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>`, `Welcome back, <i style='color: #0f0'>${ip}</i>! By the way, nice to see someone from ${country} here!`], 30, 500, () => {
      ...
      writeLine([`<i style='color: #F62459'>playday3008.github.io $$$</i>`], 120, 500, () => {
        timeouts.push(
          setTimeout(() => {
            if (app.skippedIntro) return;
